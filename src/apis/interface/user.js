...
// `order_list` 订单列表 cate=0普通订单 1社区团购订单  参数type 1待付款 2待收货 3已完成 role=1 买家的订单列表 不传或传其他值 卖家的订单列表 p页数  ziti=1时出现自提按钮
...
// adress_list1 发货清单管理 参数p （=通过审核的自提点列表）
export const adress_list1 = (data) => axios.get('Userapi/adress_list1', data)
// order_list2 发货清单列表 参数id = 自提点id
